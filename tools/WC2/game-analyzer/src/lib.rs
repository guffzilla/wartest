//! Warcraft II Game Analysis System
//! 
//! This library provides functionality for analyzing Warcraft II game files and gameplay data.

pub mod analyzer;
pub mod game_data;
pub mod utils;

pub use analyzer::WC2GameAnalyzer;

/// Result type for the WC2 game analyzer
pub type Result<T> = anyhow::Result<T>;

/// Error type for the WC2 game analyzer
