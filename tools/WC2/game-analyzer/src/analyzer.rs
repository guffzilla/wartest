...
/// WC2 Game Analyzer for analyzing Warcraft II game data
pub struct WC2GameAnalyzer {
    game_data: GameData,
...
impl Default for AnalysisConfig {
    fn default() -> Self {
        Self {
            deep_analysis: false,
            output_dir: PathBuf::from("wc2_analysis"),
            include_stats: true,
...
impl WC2GameAnalyzer {
    /// Create a new WC2 game analyzer
...
mod tests {
    ...
    fn test_analysis_config_default() {
        ...
        assert_eq!(config.output_dir, PathBuf::from("wc2_analysis"));
