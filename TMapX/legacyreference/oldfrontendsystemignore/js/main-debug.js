...
// Lightweight hot-reload poller (dev only) - DISABLED to prevent infinite reloads
if (false && (location.hostname === '127.0.0.1' || location.hostname === 'localhost')) {
...
if (location.hostname === '127.0.0.1' || location.hostname === 'localhost') {
      console.log('🔧 Dev mode: Manual hot-reload only. Run "node scripts/dev-manager.js reload" to refresh.');
}