//! Warcraft III Game Analysis System
//! 
//! This library provides functionality for analyzing Warcraft III game files and gameplay data.

pub mod analyzer;
pub mod game_data;
pub mod utils;

pub use analyzer::WC3GameAnalyzer;

/// Result type for the WC3 game analyzer
pub type Result<T> = anyhow::Result<T>;

/// Error type for the WC3 game analyzer
